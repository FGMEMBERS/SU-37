...
var navSwitch = "/controls/lighting/nav-lights";
...
#navLights.fadeIn = 0; #fade in time 
#navLights.fadeOut = 0; #fade out time
#navLights.stayOn = 3; #stable on period
#navLights.stayOff = 0; #stable off period
#navLights.turnOff = 0.12; #fade out time when turned off
#if you want to have them stable on instead, use the following line:
...
#uncomment to enable binding to gear
